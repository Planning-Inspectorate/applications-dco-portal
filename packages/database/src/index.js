...
/** @typedef {import('@pins/dco-portal-database/src/client').Prisma.PrismaClientOptions} prismaConfig */
...
export function newDatabaseClient(prismaConfig, logger) {
	...
	if (logger) {
		/** @param {import('@pins/dco-portal-database/src/client').Prisma.QueryEvent} e */
		const logQuery = (e) => {
		...
		/** @param {import('@pins/dco-portal-database/src/client').Prisma.LogEvent} e */
