...
export const OTHER_PLANS_AND_REPORTS_SUBCATEGORY_IDS = Object.freeze({
	OTHER_PLANS_DRAWINGS_SECTIONS: 'plans-drawings-sections',
	SUPPORTING_INFORMATION: 'supporting-information'
});

export const OTHER_PLANS_AND_REPORTS_SUBCATEGORY_MAPPINGS = {
	[OTHER_PLANS_AND_REPORTS_SUBCATEGORY_IDS.OTHER_PLANS_DRAWINGS_SECTIONS]:
		OTHER_PLANS_DRAWINGS_SECTIONS_SUBCATEGORY_IDS,
	[OTHER_PLANS_AND_REPORTS_SUBCATEGORY_IDS.SUPPORTING_INFORMATION]: OTHER_INFORMATION_SUBCATEGORY_IDS
};
