locals {
  ...
  tech_emails = [for rec in azurerm_monitor_action_group.dcop_tech.email_receiver : rec.email_address]
  action_group_ids = {
    tech            = azurerm_monitor_action_group.dcop_tech.id
    service_manager = azurerm_monitor_action_group.dcop_service_manager.id
