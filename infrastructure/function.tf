resource "azurerm_service_plan" "functions" {
  ...
  os_type  = "Linux"
  sku_name = var.apps_config.functions.service_plan_sku
...
resource "azurerm_storage_account" "functions" {
  ...
  #checkov:skip=CKV_AZURE_44: "Ensure Storage Account is using the latest version of TLS encryption" - deprecated terraform attribute 
