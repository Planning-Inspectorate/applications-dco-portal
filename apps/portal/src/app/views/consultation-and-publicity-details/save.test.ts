...
describe('consultation-and-publicity-details save', () => {
	describe('buildSaveController', () => {
		it('should save consultation and publicity details journey successfully if compulsory acquisition is yes', async () => {
			const mockDb = {
		...
		it('should throw error is issue encountered during db transaction to save case data', async () => {
			...
			await assert.rejects(() => controller(mockReq, mockRes), {
				message: 'error saving consultation and publicity details journey'
			});
		});
	});
});
