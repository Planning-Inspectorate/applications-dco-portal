...
export function createJourney(documentTypeId: string, questions: any, response: any, req: any) {
	...
	return new Journey({
		...
		sections: [
			new Section('Upload documents', 'upload')
		...
		journeyTitle: 'Upload document', //TODO: add category here
