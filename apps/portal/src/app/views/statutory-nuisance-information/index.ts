...
export function createRoutes(service: PortalService, applicationSectionId: string): IRouter {
	...
	const statutoryNuisanceInformationHomePage = buildStatutoryNuisanceInformationHomePage(service, applicationSectionId);
	...
	router.get('/', asyncHandler(statutoryNuisanceInformationHomePage));
