	...
	return new Journey({
		...
		sections: [
			new Section(applicationSectionDisplayName, 'details')
				.addQuestion(questions.hasNaturalEnvironmentInformation)
				.addQuestion(questions.naturalEnvironmentInformation)
				.withCondition(whenQuestionHasAnswer(questions.hasNaturalEnvironmentInformation, BOOLEAN_OPTIONS.YES))
				.addQuestion(questions.hasHistoricEnvironmentInformation)
				.addQuestion(questions.historicEnvironmentInformation)
				.withCondition(whenQuestionHasAnswer(questions.hasHistoricEnvironmentInformation, BOOLEAN_OPTIONS.YES))
		],
