...
export function createRoutes(service: PortalService, applicationSectionId: string): IRouter {
	...
	const otherConsentsOrLicencesDetailsHomePage = buildOtherConsentsOrLicencesDetailsHomePage(
		service,
	...
	router.get('/', asyncHandler(otherConsentsOrLicencesDetailsHomePage));
