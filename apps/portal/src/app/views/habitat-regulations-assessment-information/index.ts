...
export function createRoutes(service: PortalService, applicationSectionId: string): IRouter {
	...
	const habitatRegulationsAssessmentInformationHomePage = buildHabitatRegulationsAssessmentInformationHomePage(
		service,
	...
	router.get('/', asyncHandler(habitatRegulationsAssessmentInformationHomePage));
